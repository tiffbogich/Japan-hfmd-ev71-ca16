...
void eval_jac(gsl_matrix *Ft, const double *X, struct s_par *p_par, struct s_data *p_data, struct s_calc *p_calc, struct s_group ***compo_groups_drift_par_proc, double t)
{
    ...
    for(c=0; c<N_C; c++) {
        for(ac=0; ac<N_AC; ac++) {
            ...
            gsl_matrix_set(Ft, 0*N_CAC+cac, 0*N_CAC+cac, _rj[cac][7]);
            ...
            gsl_matrix_set(Ft, 2*N_CAC+cac, 6*N_CAC+cac, _rj[cac][4]);
            ...
            gsl_matrix_set(Ft, 3*N_CAC+cac, 3*N_CAC+cac, _rj[cac][8]);
            ...
            gsl_matrix_set(Ft, 3*N_CAC+cac, 8*N_CAC+cac, _rj[cac][5]);
            ...
            gsl_matrix_set(Ft, 4*N_CAC+cac, 1*N_CAC+cac, _rj[cac][21]);
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 2*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 3*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 4*N_CAC+cac, _rj[cac][19]);
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 5*N_CAC+cac, _rj[cac][21]);
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 6*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 7*N_CAC+cac, _rj[cac][5]);
            ...
            gsl_matrix_set(Ft, 5*N_CAC+cac, 1*N_CAC+cac, _rj[cac][12]);
            
            gsl_matrix_set(Ft, 5*N_CAC+cac, 2*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 5*N_CAC+cac, 3*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 5*N_CAC+cac, 4*N_CAC+cac, _rj[cac][17]);
            
            gsl_matrix_set(Ft, 5*N_CAC+cac, 5*N_CAC+cac, _rj[cac][14]);
            ...
            gsl_matrix_set(Ft, 6*N_CAC+cac, 2*N_CAC+cac, _rj[cac][6]);
            ...
            gsl_matrix_set(Ft, 6*N_CAC+cac, 6*N_CAC+cac, _rj[cac][18]);
            ...
            gsl_matrix_set(Ft, 7*N_CAC+cac, 7*N_CAC+cac, _rj[cac][20]);
            ...
            gsl_matrix_set(Ft, 8*N_CAC+cac, 8*N_CAC+cac, _rj[cac][20]);
            ...
            gsl_matrix_set(Ft, 9*N_CAC+cac, 9*N_CAC+cac, _rj[cac][20]);
            ...
            gsl_matrix_set(Ft, 10*N_CAC+cac, 10*N_CAC+cac, _rj[cac][20]);
...
void eval_Q_no_env_sto(gsl_matrix *Q, const double *X, struct s_par *p_par, struct s_data *p_data, struct s_calc *p_calc, struct s_kalman_specific_data *p_kalman_specific_data, double t)
{
    ...
    for (cac=0; cac<N_CAC; cac++) {
        ...
        i = 3 * N_CAC + cac;
        j = 3 * N_CAC + cac;
        term = gsl_spline_eval(p_calc->spline[ORDER_mu_d][cac],t,p_calc->acc[ORDER_mu_d][cac])*X[ORDER_RS*N_CAC+cac]+X[ORDER_QS*N_CAC+cac]*(par[ORDER_q][routers[ORDER_q]->map[cac]])+X[ORDER_RS*N_CAC+cac]*par[ORDER_r0_2][routers[ORDER_r0_2]->map[cac]]*par[ORDER_sigma][routers[ORDER_sigma]->map[cac]]*par[ORDER_v][routers[ORDER_v]->map[cac]]*(par[ORDER_e][routers[ORDER_e]->map[cac]]*_sf[cac][0]+1.0)*(X[ORDER_RI*N_CAC+cac]+X[ORDER_SI*N_CAC+cac]+par[ORDER_iota_2][routers[ORDER_iota_2]->map[cac]])/gsl_spline_eval(p_calc->spline[ORDER_N][cac],t,p_calc->acc[ORDER_N][cac]);
