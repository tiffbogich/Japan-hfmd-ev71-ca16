...
void eval_jac(gsl_matrix *Ft, const double *X, struct s_par *p_par, struct s_data *p_data, struct s_calc *p_calc, struct s_group ***compo_groups_drift_par_proc, double t)
{
    ...
    for(c=0; c<N_C; c++) {
        for(ac=0; ac<N_AC; ac++) {
            ...
            gsl_matrix_set(Ft, 0*N_CAC+cac, 0*N_CAC+cac, _rj[cac][13]);
            ...
            gsl_matrix_set(Ft, 0*N_CAC+cac, 6*N_CAC+cac, _rj[cac][2]);
            ...
            gsl_matrix_set(Ft, 1*N_CAC+cac, 5*N_CAC+cac, _rj[cac][16]);
            
            gsl_matrix_set(Ft, 1*N_CAC+cac, 6*N_CAC+cac, _rj[cac][11]);
            
            
            
            gsl_matrix_set(Ft, 2*N_CAC+cac, 0*N_CAC+cac, _rj[cac][19]);
            
            gsl_matrix_set(Ft, 2*N_CAC+cac, 1*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 2*N_CAC+cac, 2*N_CAC+cac, _rj[cac][3]);
            ...
            gsl_matrix_set(Ft, 2*N_CAC+cac, 6*N_CAC+cac, _rj[cac][10]);
            ...
            gsl_matrix_set(Ft, 3*N_CAC+cac, 2*N_CAC+cac, _rj[cac][6]);
            
            gsl_matrix_set(Ft, 3*N_CAC+cac, 3*N_CAC+cac, _rj[cac][5]);
            
            gsl_matrix_set(Ft, 3*N_CAC+cac, 4*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 3*N_CAC+cac, 5*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 3*N_CAC+cac, 6*N_CAC+cac, _rj[cac][6]);
            
            
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 0*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 1*N_CAC+cac, _rj[cac][7]);
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 2*N_CAC+cac, _rj[cac][12]);
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 3*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 4*N_CAC+cac, _rj[cac][0]);
            
            gsl_matrix_set(Ft, 4*N_CAC+cac, 5*N_CAC+cac, _rj[cac][7]);
            ...
            gsl_matrix_set(Ft, 5*N_CAC+cac, 1*N_CAC+cac, _rj[cac][4]);
            
            gsl_matrix_set(Ft, 5*N_CAC+cac, 2*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 5*N_CAC+cac, 3*N_CAC+cac, _rj[cac][11]);
            
            gsl_matrix_set(Ft, 5*N_CAC+cac, 4*N_CAC+cac, _rj[cac][18]);
            
            gsl_matrix_set(Ft, 5*N_CAC+cac, 5*N_CAC+cac, _rj[cac][1]);
            ...
            gsl_matrix_set(Ft, 6*N_CAC+cac, 6*N_CAC+cac, _rj[cac][20]);
