...
if(sum>0.0){
one_minus_exp_sum = (1.0-exp(-sum));
p_calc->prob[ORDER_SQ][0] = one_minus_exp_sum*((_r[6]*dt)/sum);
...
if(sum>0.0){
one_minus_exp_sum = (1.0-exp(-sum));
p_calc->prob[ORDER_QS][0] = one_minus_exp_sum*((_r[6]*dt)/sum);
...
if(sum>0.0){
one_minus_exp_sum = (1.0-exp(-sum));
p_calc->prob[ORDER_QR][0] = one_minus_exp_sum*((_r[6]*dt)/sum);
...
if(sum>0.0){
one_minus_exp_sum = (1.0-exp(-sum));
p_calc->prob[ORDER_RQ][0] = one_minus_exp_sum*((_r[6]*dt)/sum);
...
X[ORDER_RS*N_CAC+cac] = p_calc->inc[ORDER_RS][cac][3] + p_calc->inc[ORDER_QS][cac][1];
...
X[ORDER_QR*N_CAC+cac] = p_calc->inc[ORDER_QR][cac][2] + p_calc->inc[ORDER_IR][cac][1] + p_calc->inc[ORDER_RR][cac][0];
X[ORDER_RQ*N_CAC+cac] = p_calc->inc[ORDER_RQ][cac][2] + p_calc->inc[ORDER_RI][cac][1] + p_calc->inc[ORDER_RR][cac][1];
...

{
    ...
    for(c=0;c<N_C;c++) {
        for(ac=0; ac<N_AC; ac++) {
            ...
            f[0*N_CAC+cac] = X[0*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SS*N_CAC+cac]) - (_r[cac][3]*X[ORDER_SS*N_CAC+cac]) - (_r[cac][1]*X[ORDER_SS*N_CAC+cac]) + (_r[cac][6]))*dt + - sqrt((_r[cac][8]*X[ORDER_SS*N_CAC+cac]))*dem_sto__1[cac]- sqrt((_r[cac][3]*X[ORDER_SS*N_CAC+cac]))*dem_sto__12[cac]- sqrt((_r[cac][1]*X[ORDER_SS*N_CAC+cac]))*dem_sto__13[cac]+ sqrt((_r[cac][6]))*dem_sto__0[cac];
            f[1*N_CAC+cac] = X[1*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_IS*N_CAC+cac]) - (_r[cac][5]*X[ORDER_IS*N_CAC+cac]) + (_r[cac][3]*X[ORDER_SS*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_IS*N_CAC+cac]))*dem_sto__2[cac]- sqrt((_r[cac][5]*X[ORDER_IS*N_CAC+cac]))*dem_sto__16[cac]+ sqrt((_r[cac][3]*X[ORDER_SS*N_CAC+cac]))*dem_sto__12[cac];
            f[2*N_CAC+cac] = X[2*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SI*N_CAC+cac]) - (_r[cac][5]*X[ORDER_SI*N_CAC+cac]) + (_r[cac][1]*X[ORDER_SS*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_SI*N_CAC+cac]))*dem_sto__3[cac]- sqrt((_r[cac][5]*X[ORDER_SI*N_CAC+cac]))*dem_sto__17[cac]+ sqrt((_r[cac][1]*X[ORDER_SS*N_CAC+cac]))*dem_sto__13[cac];
            f[3*N_CAC+cac] = X[3*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RS*N_CAC+cac]) - (_r[cac][2]*X[ORDER_RS*N_CAC+cac]) - (_r[cac][3]*X[ORDER_RS*N_CAC+cac]) + (_r[cac][0]*X[ORDER_QS*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_RS*N_CAC+cac]))*dem_sto__4[cac]- sqrt((_r[cac][2]*X[ORDER_RS*N_CAC+cac]))*dem_sto__15[cac]- sqrt((_r[cac][3]*X[ORDER_RS*N_CAC+cac]))*dem_sto__24[cac]+ sqrt((_r[cac][0]*X[ORDER_QS*N_CAC+cac]))*dem_sto__20[cac];
            f[4*N_CAC+cac] = X[4*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SR*N_CAC+cac]) - (_r[cac][4]*X[ORDER_SR*N_CAC+cac]) - (_r[cac][1]*X[ORDER_SR*N_CAC+cac]) + (_r[cac][0]*X[ORDER_SQ*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_SR*N_CAC+cac]))*dem_sto__5[cac]- sqrt((_r[cac][4]*X[ORDER_SR*N_CAC+cac]))*dem_sto__14[cac]- sqrt((_r[cac][1]*X[ORDER_SR*N_CAC+cac]))*dem_sto__25[cac]+ sqrt((_r[cac][0]*X[ORDER_SQ*N_CAC+cac]))*dem_sto__21[cac];
            f[5*N_CAC+cac] = X[5*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_IR*N_CAC+cac]) - (_r[cac][5]*X[ORDER_IR*N_CAC+cac]) + (_r[cac][4]*X[ORDER_SR*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_IR*N_CAC+cac]))*dem_sto__6[cac]- sqrt((_r[cac][5]*X[ORDER_IR*N_CAC+cac]))*dem_sto__18[cac]+ sqrt((_r[cac][4]*X[ORDER_SR*N_CAC+cac]))*dem_sto__14[cac];
            f[6*N_CAC+cac] = X[6*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RI*N_CAC+cac]) - (_r[cac][5]*X[ORDER_RI*N_CAC+cac]) + (_r[cac][2]*X[ORDER_RS*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_RI*N_CAC+cac]))*dem_sto__7[cac]- sqrt((_r[cac][5]*X[ORDER_RI*N_CAC+cac]))*dem_sto__19[cac]+ sqrt((_r[cac][2]*X[ORDER_RS*N_CAC+cac]))*dem_sto__15[cac];
            f[7*N_CAC+cac] = X[7*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SQ*N_CAC+cac]) - (_r[cac][0]*X[ORDER_SQ*N_CAC+cac]) + (_r[cac][5]*X[ORDER_SI*N_CAC+cac]) + (_r[cac][1]*X[ORDER_SR*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_SQ*N_CAC+cac]))*dem_sto__8[cac]- sqrt((_r[cac][0]*X[ORDER_SQ*N_CAC+cac]))*dem_sto__21[cac]+ sqrt((_r[cac][5]*X[ORDER_SI*N_CAC+cac]))*dem_sto__17[cac]+ sqrt((_r[cac][1]*X[ORDER_SR*N_CAC+cac]))*dem_sto__25[cac];
            f[8*N_CAC+cac] = X[8*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_QS*N_CAC+cac]) - (_r[cac][0]*X[ORDER_QS*N_CAC+cac]) + (_r[cac][5]*X[ORDER_IS*N_CAC+cac]) + (_r[cac][3]*X[ORDER_RS*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_QS*N_CAC+cac]))*dem_sto__9[cac]- sqrt((_r[cac][0]*X[ORDER_QS*N_CAC+cac]))*dem_sto__20[cac]+ sqrt((_r[cac][5]*X[ORDER_IS*N_CAC+cac]))*dem_sto__16[cac]+ sqrt((_r[cac][3]*X[ORDER_RS*N_CAC+cac]))*dem_sto__24[cac];
            f[9*N_CAC+cac] = X[9*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_QR*N_CAC+cac]) - (_r[cac][0]*X[ORDER_QR*N_CAC+cac]) + (_r[cac][5]*X[ORDER_IR*N_CAC+cac]) + (_r[cac][7]))*dt + - sqrt((_r[cac][8]*X[ORDER_QR*N_CAC+cac]))*dem_sto__10[cac]- sqrt((_r[cac][0]*X[ORDER_QR*N_CAC+cac]))*dem_sto__22[cac]+ sqrt((_r[cac][5]*X[ORDER_IR*N_CAC+cac]))*dem_sto__18[cac]+ sqrt((_r[cac][7]))*dem_sto__26[cac];
            f[10*N_CAC+cac] = X[10*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RQ*N_CAC+cac]) - (_r[cac][0]*X[ORDER_RQ*N_CAC+cac]) + (_r[cac][5]*X[ORDER_RI*N_CAC+cac]) + (_r[cac][9]))*dt + - sqrt((_r[cac][8]*X[ORDER_RQ*N_CAC+cac]))*dem_sto__11[cac]- sqrt((_r[cac][0]*X[ORDER_RQ*N_CAC+cac]))*dem_sto__23[cac]+ sqrt((_r[cac][5]*X[ORDER_RI*N_CAC+cac]))*dem_sto__19[cac]+ sqrt((_r[cac][9]))*dem_sto__27[cac];
        }
    }
    ...
    for (ts=0; ts<obs2ts[o]->n_ts_unique; ts++) {
        ...
        for (n_cac=0; n_cac<obs2ts[o]->n_cac[ts]; n_cac++) {
            ...
            sum_inc += ( + (_r[cac][5]*X[ORDER_IS*N_CAC+cac]) + (_r[cac][5]*X[ORDER_IR*N_CAC+cac]))*dt + sqrt((_r[cac][5]*X[ORDER_IS*N_CAC+cac]))*dem_sto__16[cac]+ sqrt((_r[cac][5]*X[ORDER_IR*N_CAC+cac]))*dem_sto__18[cac];
        }
    ...
    for (ts=0; ts<obs2ts[o]->n_ts_unique; ts++) {
        ...
        for (n_cac=0; n_cac<obs2ts[o]->n_cac[ts]; n_cac++) {
            ...
            sum_inc += ( + (_r[cac][5]*X[ORDER_SI*N_CAC+cac]) + (_r[cac][5]*X[ORDER_RI*N_CAC+cac]))*dt + sqrt((_r[cac][5]*X[ORDER_SI*N_CAC+cac]))*dem_sto__17[cac]+ sqrt((_r[cac][5]*X[ORDER_RI*N_CAC+cac]))*dem_sto__19[cac];
        }
...

{
    ...
    for(c=0;c<N_C;c++) {
        for(ac=0; ac<N_AC; ac++) {
            ...
            f[0*N_CAC+cac] = X[0*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SS*N_CAC+cac]) - (_r[cac][3]*X[ORDER_SS*N_CAC+cac]) - (_r[cac][1]*X[ORDER_SS*N_CAC+cac]) + (_r[cac][6]))*dt + - sqrt((_r[cac][8]*X[ORDER_SS*N_CAC+cac]))*dem_sto__1[cac]- sqrt((_r[cac][3]*X[ORDER_SS*N_CAC+cac]))*dem_sto__12[cac]- sqrt((_r[cac][1]*X[ORDER_SS*N_CAC+cac]))*dem_sto__13[cac]+ sqrt((_r[cac][6]))*dem_sto__0[cac] + - (_r[cac][3]*X[ORDER_SS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac]- (_r[cac][1]*X[ORDER_SS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
            f[1*N_CAC+cac] = X[1*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_IS*N_CAC+cac]) - (_r[cac][5]*X[ORDER_IS*N_CAC+cac]) + (_r[cac][3]*X[ORDER_SS*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_IS*N_CAC+cac]))*dem_sto__2[cac]- sqrt((_r[cac][5]*X[ORDER_IS*N_CAC+cac]))*dem_sto__16[cac]+ sqrt((_r[cac][3]*X[ORDER_SS*N_CAC+cac]))*dem_sto__12[cac] + + (_r[cac][3]*X[ORDER_SS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[2*N_CAC+cac] = X[2*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SI*N_CAC+cac]) - (_r[cac][5]*X[ORDER_SI*N_CAC+cac]) + (_r[cac][1]*X[ORDER_SS*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_SI*N_CAC+cac]))*dem_sto__3[cac]- sqrt((_r[cac][5]*X[ORDER_SI*N_CAC+cac]))*dem_sto__17[cac]+ sqrt((_r[cac][1]*X[ORDER_SS*N_CAC+cac]))*dem_sto__13[cac] + + (_r[cac][1]*X[ORDER_SS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
            f[3*N_CAC+cac] = X[3*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RS*N_CAC+cac]) - (_r[cac][2]*X[ORDER_RS*N_CAC+cac]) - (_r[cac][3]*X[ORDER_RS*N_CAC+cac]) + (_r[cac][0]*X[ORDER_QS*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_RS*N_CAC+cac]))*dem_sto__4[cac]- sqrt((_r[cac][2]*X[ORDER_RS*N_CAC+cac]))*dem_sto__15[cac]- sqrt((_r[cac][3]*X[ORDER_RS*N_CAC+cac]))*dem_sto__24[cac]+ sqrt((_r[cac][0]*X[ORDER_QS*N_CAC+cac]))*dem_sto__20[cac] + - (_r[cac][2]*X[ORDER_RS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac]- (_r[cac][3]*X[ORDER_RS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[4*N_CAC+cac] = X[4*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SR*N_CAC+cac]) - (_r[cac][4]*X[ORDER_SR*N_CAC+cac]) - (_r[cac][1]*X[ORDER_SR*N_CAC+cac]) + (_r[cac][0]*X[ORDER_SQ*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_SR*N_CAC+cac]))*dem_sto__5[cac]- sqrt((_r[cac][4]*X[ORDER_SR*N_CAC+cac]))*dem_sto__14[cac]- sqrt((_r[cac][1]*X[ORDER_SR*N_CAC+cac]))*dem_sto__25[cac]+ sqrt((_r[cac][0]*X[ORDER_SQ*N_CAC+cac]))*dem_sto__21[cac] + - (_r[cac][4]*X[ORDER_SR*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac]- (_r[cac][1]*X[ORDER_SR*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
            f[5*N_CAC+cac] = X[5*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_IR*N_CAC+cac]) - (_r[cac][5]*X[ORDER_IR*N_CAC+cac]) + (_r[cac][4]*X[ORDER_SR*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_IR*N_CAC+cac]))*dem_sto__6[cac]- sqrt((_r[cac][5]*X[ORDER_IR*N_CAC+cac]))*dem_sto__18[cac]+ sqrt((_r[cac][4]*X[ORDER_SR*N_CAC+cac]))*dem_sto__14[cac] + + (_r[cac][4]*X[ORDER_SR*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[6*N_CAC+cac] = X[6*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RI*N_CAC+cac]) - (_r[cac][5]*X[ORDER_RI*N_CAC+cac]) + (_r[cac][2]*X[ORDER_RS*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_RI*N_CAC+cac]))*dem_sto__7[cac]- sqrt((_r[cac][5]*X[ORDER_RI*N_CAC+cac]))*dem_sto__19[cac]+ sqrt((_r[cac][2]*X[ORDER_RS*N_CAC+cac]))*dem_sto__15[cac] + + (_r[cac][2]*X[ORDER_RS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
            f[7*N_CAC+cac] = X[7*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SQ*N_CAC+cac]) - (_r[cac][0]*X[ORDER_SQ*N_CAC+cac]) + (_r[cac][5]*X[ORDER_SI*N_CAC+cac]) + (_r[cac][1]*X[ORDER_SR*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_SQ*N_CAC+cac]))*dem_sto__8[cac]- sqrt((_r[cac][0]*X[ORDER_SQ*N_CAC+cac]))*dem_sto__21[cac]+ sqrt((_r[cac][5]*X[ORDER_SI*N_CAC+cac]))*dem_sto__17[cac]+ sqrt((_r[cac][1]*X[ORDER_SR*N_CAC+cac]))*dem_sto__25[cac] + + (_r[cac][1]*X[ORDER_SR*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
            f[8*N_CAC+cac] = X[8*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_QS*N_CAC+cac]) - (_r[cac][0]*X[ORDER_QS*N_CAC+cac]) + (_r[cac][5]*X[ORDER_IS*N_CAC+cac]) + (_r[cac][3]*X[ORDER_RS*N_CAC+cac]))*dt + - sqrt((_r[cac][8]*X[ORDER_QS*N_CAC+cac]))*dem_sto__9[cac]- sqrt((_r[cac][0]*X[ORDER_QS*N_CAC+cac]))*dem_sto__20[cac]+ sqrt((_r[cac][5]*X[ORDER_IS*N_CAC+cac]))*dem_sto__16[cac]+ sqrt((_r[cac][3]*X[ORDER_RS*N_CAC+cac]))*dem_sto__24[cac] + + (_r[cac][3]*X[ORDER_RS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[9*N_CAC+cac] = X[9*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_QR*N_CAC+cac]) - (_r[cac][0]*X[ORDER_QR*N_CAC+cac]) + (_r[cac][5]*X[ORDER_IR*N_CAC+cac]) + (_r[cac][7]))*dt + - sqrt((_r[cac][8]*X[ORDER_QR*N_CAC+cac]))*dem_sto__10[cac]- sqrt((_r[cac][0]*X[ORDER_QR*N_CAC+cac]))*dem_sto__22[cac]+ sqrt((_r[cac][5]*X[ORDER_IR*N_CAC+cac]))*dem_sto__18[cac]+ sqrt((_r[cac][7]))*dem_sto__26[cac] + + (_r[cac][7])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[10*N_CAC+cac] = X[10*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RQ*N_CAC+cac]) - (_r[cac][0]*X[ORDER_RQ*N_CAC+cac]) + (_r[cac][5]*X[ORDER_RI*N_CAC+cac]) + (_r[cac][9]))*dt + - sqrt((_r[cac][8]*X[ORDER_RQ*N_CAC+cac]))*dem_sto__11[cac]- sqrt((_r[cac][0]*X[ORDER_RQ*N_CAC+cac]))*dem_sto__23[cac]+ sqrt((_r[cac][5]*X[ORDER_RI*N_CAC+cac]))*dem_sto__19[cac]+ sqrt((_r[cac][9]))*dem_sto__27[cac] + + (_r[cac][9])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
        }
    }
...

{
    ...
    for(c=0;c<N_C;c++) {
        for(ac=0; ac<N_AC; ac++) {
            ...
            f[0*N_CAC+cac] = X[0*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SS*N_CAC+cac]) - (_r[cac][3]*X[ORDER_SS*N_CAC+cac]) - (_r[cac][1]*X[ORDER_SS*N_CAC+cac]) + (_r[cac][6]))*dt + - (_r[cac][3]*X[ORDER_SS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac]- (_r[cac][1]*X[ORDER_SS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
            f[1*N_CAC+cac] = X[1*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_IS*N_CAC+cac]) - (_r[cac][5]*X[ORDER_IS*N_CAC+cac]) + (_r[cac][3]*X[ORDER_SS*N_CAC+cac]))*dt + + (_r[cac][3]*X[ORDER_SS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[2*N_CAC+cac] = X[2*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SI*N_CAC+cac]) - (_r[cac][5]*X[ORDER_SI*N_CAC+cac]) + (_r[cac][1]*X[ORDER_SS*N_CAC+cac]))*dt + + (_r[cac][1]*X[ORDER_SS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
            f[3*N_CAC+cac] = X[3*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RS*N_CAC+cac]) - (_r[cac][2]*X[ORDER_RS*N_CAC+cac]) - (_r[cac][3]*X[ORDER_RS*N_CAC+cac]) + (_r[cac][0]*X[ORDER_QS*N_CAC+cac]))*dt + - (_r[cac][2]*X[ORDER_RS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac]- (_r[cac][3]*X[ORDER_RS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[4*N_CAC+cac] = X[4*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SR*N_CAC+cac]) - (_r[cac][4]*X[ORDER_SR*N_CAC+cac]) - (_r[cac][1]*X[ORDER_SR*N_CAC+cac]) + (_r[cac][0]*X[ORDER_SQ*N_CAC+cac]))*dt + - (_r[cac][4]*X[ORDER_SR*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac]- (_r[cac][1]*X[ORDER_SR*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
            f[5*N_CAC+cac] = X[5*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_IR*N_CAC+cac]) - (_r[cac][5]*X[ORDER_IR*N_CAC+cac]) + (_r[cac][4]*X[ORDER_SR*N_CAC+cac]))*dt + + (_r[cac][4]*X[ORDER_SR*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[6*N_CAC+cac] = X[6*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RI*N_CAC+cac]) - (_r[cac][5]*X[ORDER_RI*N_CAC+cac]) + (_r[cac][2]*X[ORDER_RS*N_CAC+cac]))*dt + + (_r[cac][2]*X[ORDER_RS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
            f[7*N_CAC+cac] = X[7*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SQ*N_CAC+cac]) - (_r[cac][0]*X[ORDER_SQ*N_CAC+cac]) + (_r[cac][5]*X[ORDER_SI*N_CAC+cac]) + (_r[cac][1]*X[ORDER_SR*N_CAC+cac]))*dt + + (_r[cac][1]*X[ORDER_SR*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
            f[8*N_CAC+cac] = X[8*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_QS*N_CAC+cac]) - (_r[cac][0]*X[ORDER_QS*N_CAC+cac]) + (_r[cac][5]*X[ORDER_IS*N_CAC+cac]) + (_r[cac][3]*X[ORDER_RS*N_CAC+cac]))*dt + + (_r[cac][3]*X[ORDER_RS*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[9*N_CAC+cac] = X[9*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_QR*N_CAC+cac]) - (_r[cac][0]*X[ORDER_QR*N_CAC+cac]) + (_r[cac][5]*X[ORDER_IR*N_CAC+cac]) + (_r[cac][7]))*dt + + (_r[cac][7])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[10*N_CAC+cac] = X[10*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RQ*N_CAC+cac]) - (_r[cac][0]*X[ORDER_RQ*N_CAC+cac]) + (_r[cac][5]*X[ORDER_RI*N_CAC+cac]) + (_r[cac][9]))*dt + + (_r[cac][9])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__1[cac];
        }
    }
    ...
    for (ts=0; ts<obs2ts[o]->n_ts_unique; ts++) {
        ...
        for (n_cac=0; n_cac<obs2ts[o]->n_cac[ts]; n_cac++) {
            ...
            sum_inc += ( + (_r[cac][5]*X[ORDER_IS*N_CAC+cac]) + (_r[cac][5]*X[ORDER_IR*N_CAC+cac]))*dt ;
        }
    ...
    for (ts=0; ts<obs2ts[o]->n_ts_unique; ts++) {
        ...
        for (n_cac=0; n_cac<obs2ts[o]->n_cac[ts]; n_cac++) {
            ...
            sum_inc += ( + (_r[cac][5]*X[ORDER_SI*N_CAC+cac]) + (_r[cac][5]*X[ORDER_RI*N_CAC+cac]))*dt ;
        }
...

{
    ...
    for(c=0;c<N_C;c++) {
        for(ac=0; ac<N_AC; ac++) {
            ...
            f[0*N_CAC+cac] = X[0*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SS*N_CAC+cac]) - (_r[cac][3]*X[ORDER_SS*N_CAC+cac]) - (_r[cac][1]*X[ORDER_SS*N_CAC+cac]) + (_r[cac][6]))*dt;
            f[1*N_CAC+cac] = X[1*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_IS*N_CAC+cac]) - (_r[cac][5]*X[ORDER_IS*N_CAC+cac]) + (_r[cac][3]*X[ORDER_SS*N_CAC+cac]))*dt;
            f[2*N_CAC+cac] = X[2*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SI*N_CAC+cac]) - (_r[cac][5]*X[ORDER_SI*N_CAC+cac]) + (_r[cac][1]*X[ORDER_SS*N_CAC+cac]))*dt;
            f[3*N_CAC+cac] = X[3*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RS*N_CAC+cac]) - (_r[cac][2]*X[ORDER_RS*N_CAC+cac]) - (_r[cac][3]*X[ORDER_RS*N_CAC+cac]) + (_r[cac][0]*X[ORDER_QS*N_CAC+cac]))*dt;
            f[4*N_CAC+cac] = X[4*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SR*N_CAC+cac]) - (_r[cac][4]*X[ORDER_SR*N_CAC+cac]) - (_r[cac][1]*X[ORDER_SR*N_CAC+cac]) + (_r[cac][0]*X[ORDER_SQ*N_CAC+cac]))*dt;
            f[5*N_CAC+cac] = X[5*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_IR*N_CAC+cac]) - (_r[cac][5]*X[ORDER_IR*N_CAC+cac]) + (_r[cac][4]*X[ORDER_SR*N_CAC+cac]))*dt;
            f[6*N_CAC+cac] = X[6*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RI*N_CAC+cac]) - (_r[cac][5]*X[ORDER_RI*N_CAC+cac]) + (_r[cac][2]*X[ORDER_RS*N_CAC+cac]))*dt;
            f[7*N_CAC+cac] = X[7*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_SQ*N_CAC+cac]) - (_r[cac][0]*X[ORDER_SQ*N_CAC+cac]) + (_r[cac][5]*X[ORDER_SI*N_CAC+cac]) + (_r[cac][1]*X[ORDER_SR*N_CAC+cac]))*dt;
            f[8*N_CAC+cac] = X[8*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_QS*N_CAC+cac]) - (_r[cac][0]*X[ORDER_QS*N_CAC+cac]) + (_r[cac][5]*X[ORDER_IS*N_CAC+cac]) + (_r[cac][3]*X[ORDER_RS*N_CAC+cac]))*dt;
            f[9*N_CAC+cac] = X[9*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_QR*N_CAC+cac]) - (_r[cac][0]*X[ORDER_QR*N_CAC+cac]) + (_r[cac][5]*X[ORDER_IR*N_CAC+cac]) + (_r[cac][7]))*dt;
            f[10*N_CAC+cac] = X[10*N_CAC+cac] +  ( - (_r[cac][8]*X[ORDER_RQ*N_CAC+cac]) - (_r[cac][0]*X[ORDER_RQ*N_CAC+cac]) + (_r[cac][5]*X[ORDER_RI*N_CAC+cac]) + (_r[cac][9]))*dt;
        }
    }
